          ...
          <ul className="shop-data-items">
            <li>
              ...
              <div className="data-item__content">
                <h4>Free Shipping</h4>
                <p>All purchases over Rs. 599 are eligible for free shipping via home delivery.</p>
              </div>
            </li>
            ...
            <li>
              ...
              <div className="data-item__content">
                <h4>Easy Payments</h4>
                <p>All payments are processed instantly over a secure payment protocol with any payment method such as Credit card, Debit card, Visa, Phone pe, Google pay, etc.</p>
              </div>
            </li>
            ...
            <li>
              ...
              <div className="data-item__content">
                ...
                <p>Designed to last, each of our products has been crafted with the finest materials. Our high quality products are available everytime.</p>
              </div>
            </li>
          </ul>
        </div>
